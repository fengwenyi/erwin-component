package com.fengwenyi.erwin.component.log.client.config;
...
@Configuration
@EnableAsync
public class LogClientThreadPoolConfig extends AbstractThreadPoolConfig {
    ...
    @Bean
    public ThreadPoolTaskExecutor logClientPool() {
        return genExecutor(PREFIX + "LogClient-");
    }
